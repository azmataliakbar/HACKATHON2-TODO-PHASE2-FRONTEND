    ...
    <div className="min-h-screen flex flex-col justify-center py-6 sm:px-6 lg:px-8 neon-float">
      <div className="sm:mx-auto sm:w-full sm:max-w-md mx-responsive">
        ...
        <p className="mt-2 text-center text-responsive-base text-gray-600 dark:text-gray-300">
          Join NeonTask to start managing your tasks
        </p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md mx-responsive">
        <div className="card-responsive neon-glow-blue">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              <label htmlFor="name" className="block text-responsive-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                Full name
              </label>
              <div className="mt-1">
                <input
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-responsive-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                Confirm Password
              </label>
              <div className="mt-1">
                <input
